...
Once the token is verified, the Lambda Authorizer should return an output that assumes an output such as the one provided below.###### Lambda Authorizer Output Sample
